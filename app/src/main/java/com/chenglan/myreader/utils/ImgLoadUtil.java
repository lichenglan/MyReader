...
import com.chenglan.myreader.R;
...
//                .into(new GlideDrawableImageViewTarget(imageView, 1));
    ...
    public static void showMovieImg(ImageView imageView, String url) {
        Glide.with(imageView.getContext())
                .load(url)
                .crossFade(500)
                .override((int) CommonResorceUtils.getDimens(R.dimen.movie_detail_width), (int) CommonResorceUtils.getDimens(R.dimen.movie_detail_height))
    ...
    public static void showBookImg(ImageView imageView, String url) {
        Glide.with(imageView.getContext())
                .load(url)
                .crossFade(500)
                .override((int) CommonResorceUtils.getDimens(R.dimen.book_detail_width), (int) CommonResorceUtils.getDimens(R.dimen.book_detail_height))
